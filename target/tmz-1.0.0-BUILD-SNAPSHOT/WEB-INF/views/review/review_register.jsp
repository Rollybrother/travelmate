                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                        	 <form role="form" action="${contextPath}/review/review-register" method="post" name="review_frm_board">
								 ...
								 <label>제목</label> <input type="text" class="form-control" name="rv_title" style="width :100%; color : white;">
								 </div>
								<div class="form-group">
								 <label>내용</label> <textarea class="form-control" rows="3" name="rv_content"></textarea>
								 </div>
								<div class="form-group">
								 <label>작성자</label> <input class="form-control" name="rv_writer"
								...
								<button type="button" class="btn btn-primary" id="btn_register">등록</button>
								 ...
								 onclick="location.href='${contextPath}/review/review-list'">취소</button>
								 <sec:csrfInput />
							 </form>  
                        </div>
                        <!-- /.panel-body -->
